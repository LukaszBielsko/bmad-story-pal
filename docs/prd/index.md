...
- [StoryMagic Product Requirements Document (PRD)](#table-of-contents)
  ...
  - [User Interface Design Goals](./user-interface-design-goals.md)
    ...
    - [Design System Specifications](./user-interface-design-goals.md#design-system-specifications)
